# https://github.com/cran/erer/blob/master/R/ocME.r?fbclid=IwAR3do93Ze6rSOgmcEKU3Orn5g72TPUtvjOBwoYsAD0-3oDE3sFoumSljwnQ

ocME_robust <- function(w, rev.dum = TRUE, digits = 3)
{
  # 1. Check inputs
  if (!inherits(w, "polr")) {
  ...
  V2 <- sandwich(w) # This is the only difference to the orig. function. Source: https://stackoverflow.com/questions/27367974/different-robust-standard-errors-of-logit-regression-in-stata-and-r
